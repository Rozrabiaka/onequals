...
$this->title = 'Blog Summaries';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="blog-summary-index">
    <p>
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        ...
                        ', \yii\helpers\Url::to(['/page/page/update', 'id' => $model->id, 'category' => \backend\models\CreateBlog::BLOG_CATEGORY_SUMMARY]));
                    },
                ],
            ],
        ]
