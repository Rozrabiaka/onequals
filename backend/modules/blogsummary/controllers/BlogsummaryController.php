...
/**
 * BlogsummaryController implements the CRUD actions for BlogSummary model.
 */
class BlogsummaryController extends Controller
{
    ...
    /**
     * Displays a single BlogSummary model.
     * @param int $id ID
     * @return mixed
    ...
    /**
     * Deletes an existing BlogSummary model.
