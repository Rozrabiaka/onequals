...
$this->title = 'Blog Legislations';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="blog-legislation-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function () {return 'Законодавство';}
            ],
            [
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        ...
                        ', \yii\helpers\Url::to(['/page/page/update', 'id' => $model->id, 'category' => $model->blog_category]));
                    },
                ],
            ],
        ]
